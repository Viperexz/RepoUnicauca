...
{
  int abrirSesion (sop_corba.GestionUsuariosPackage.usuarioDTO objUsuario);
  boolean consultarUsuario (int id, sop_corba.GestionUsuariosPackage.usuarioDTOHolder objUsuario);
