...
%% ------------------------------------------------------------------------------------------------------------------------
% Borde izquierdo de un rectángulo/cuadrado
...
%------------------------------------------------------------------------------------------------------------------------
% Borde derecho de un rectángulo/cuadrado
...
%------------------------------------------------------------------------------------------------------------------------
% Borde inferior de un rectángulo/cuadrado
...
%------------------------------------------------------------------------------------------------------------------------
% Borde superior de un rectángulo/cuadrado
...
%% ------------------------------------------------------------------------------------------------------------------------
% Apilar las matrices en la celda
...
%% ------------------------------------------------------------------------------------------------------------------------
% Reemplace los valores con intersección/puntos actualizados
...
%% ------------------------------------------------------------------------------------------------------------------------
% Descartar fuera de los puntos límite
[rowvX,colvX] = find(vx < imX1 | vx > imX2);
[rowvY,colvY] = find(vy < imY1 | vy > imY2);

% Índices de valores únicos en la columna
[~, indvY] = unique(colvY);
[~, indvX] = unique(colvX);
...
% Vértices válidos dentro de los límites
vx(:,[duplicatevX;duplicatevY]) = [];
vy(:,[duplicatevX;duplicatevY]) = [];

%% ------------------------------------------------------------------------------------------------------------------------
% Recortar valores de vértices
if clip2boundary
...
if showFigure
    ...
    h1 = voronoi(X,Y);
    axis equal
    title('Diagrama de voronoi Original')
    ...
    hold off
    axis equal
    title('imagen del diagrama Original')
    ...
    hold off
    axis equal
    title('Diagrama de voronoi recortada.')
